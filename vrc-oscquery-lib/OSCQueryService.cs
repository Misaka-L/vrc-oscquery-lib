...
namespace VRC.OSCQuery
{
    public class OSCQueryService : IDisposable
    {
        ...
        {
        } // Need to have this empty constructor for the Builder
        ...
        public List<IPAddress> HostIP { get; set; } = [];
        public List<IPAddress> OscIP { get; set; } = [];

        public bool UseDynamicOscIp { get; set; }
        public bool ListenAnyHost { get; set; }
        ...
        public void UseHttpServer(ILoggerFactory loggerFactory = null)
        {
            _http?.Dispose();

            _http = new OSCQueryHttpServer(this, loggerFactory ?? new NullLoggerFactory());
        }
        ...
        public async Task StartHttpServer()
        {
            if (_http == null)
            {
                throw new InvalidOperationException(
                    "No HTTP server has been added to this OSCQueryService. Please add one before starting.");
            }
        ...
        public void AdvertiseOSCQueryService(string serviceName, int port = -1)
        {
            ...
            Discovery.Advertise(new OSCQueryServiceProfile(serviceName, HostIP, port,
                OSCQueryServiceProfile.ProfileServiceType.OSCQuery));
        }
        ...
        public void AdvertiseOSCService(string serviceName, int port = -1)
        {
            ...
            Discovery.Advertise(new OSCQueryServiceProfile(serviceName, OscIP, port,
                OSCQueryServiceProfile.ProfileServiceType.OSC));
        }
        ...
        /// <returns></returns>
        public bool AddEndpoint(string path, string oscTypeString, Attributes.AccessValues accessValues,
        ...
        public bool AddEndpoint<T>(string path, Attributes.AccessValues accessValues, object[] initialValue = null,
            string description = "")
        {
